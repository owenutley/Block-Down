...
export const CHARACTERS: GameCharacter[] = [
  ...
  { id: 'retro', name: 'Pixel Bot', cost: 0, description: 'Classic 8-bit pixel bot with CRT screen visor, joystick antenna, and D-pad ears.', earnRequirement: 'Subreddit Subscription' },
