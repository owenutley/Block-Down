...
export const THEMES: Theme[] = [
  {
    ...
    name: 'Neon Cyber',
    cost: 0,
    description: 'High-tech cyan cyber grid featuring sleek neon glow effects, extruded hexagon tiles, and dark futuristic wall blocks.',
  ...
  },
  {
    ...
    name: 'Deep Space',
    cost: 2500,
    description: 'Stellar cosmic void with deep indigo background, floating rockets and stars, and space-age hexagon blocks.',
