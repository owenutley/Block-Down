...
export const Splash = () => {
  ...
  return (
    <div className={`relative flex h-[100dvh] w-full overflow-hidden flex-col items-center justify-between gap-1 sm:gap-2 ${getThemeBgClass(activeTheme, activeThemeStyle)} px-4 py-3 sm:py-4 select-none`}>
      ...
      {/* Mobile-Only Header Structure (Preserved exactly as-is for mobile viewports) */}
      <div className="sm:hidden w-full flex flex-col items-center gap-1 shrink-0 z-20">
        {/* Top Navigation Row */}
        <div className="w-full max-w-sm flex flex-row items-center justify-center gap-2 z-30 shrink-0 pt-0.5">
          <button
            onClick={(e) => requestExpandedMode(e.nativeEvent, 'campaign')}
            className="flex-1 min-w-0 flex items-center justify-center bg-slate-900/90 py-1.5 px-2 rounded-full border border-amber-400/40 shadow hover:border-amber-400/80 hover:scale-105 active:scale-95 transition-all text-amber-300 font-extrabold text-[11px] tracking-wide cursor-pointer select-none"
          >
          ...
          <button
            ...
            className="flex-1 min-w-0 flex items-center justify-center bg-slate-900/90 py-1.5 px-2 rounded-full border border-purple-400/40 shadow hover:border-purple-400/80 hover:scale-105 active:scale-95 transition-all text-purple-300 font-extrabold text-[11px] tracking-wide cursor-pointer select-none"
          >
          ...
          <button
            ...
            className="flex-1 min-w-0 flex items-center justify-center bg-slate-900/90 py-1.5 px-2 rounded-full border border-emerald-400/40 shadow hover:border-emerald-400/80 hover:scale-105 active:scale-95 transition-all text-emerald-300 font-extrabold text-[11px] tracking-wide cursor-pointer select-none"
          >
        ...
        <div className="w-full max-w-sm flex flex-row items-center justify-between gap-2 px-1 z-20 shrink-0 text-[10px] font-bold">
          {/* Streak Indicator */}
        ...
        <div className="flex flex-col items-center shrink-0 gap-0.5 z-20">
          ...
          {/* Solve Status & Social Proof Leaderboard */}
          <div className="flex flex-col items-center justify-center gap-1 mt-0.5 animate-fade-in shrink-0 select-none max-w-full px-2">
            ...
            <div className="flex items-center justify-center gap-1 text-[10px] shrink-0">
              {topLeader ? (
      ...
      {/* Desktop / Tablet Header Structure (Polished HUD layout for wider screens) */}
      <div className="hidden sm:flex flex-col items-center gap-2.5 w-full max-w-2xl px-2 z-20 shrink-0">
        {/* Tier 1: High-End HUD Top Bar */}
        <div className="w-full flex items-center justify-between gap-3 pt-1">
          ...
          {/* Segmented Glass Navigation Pill */}
          <div className="flex items-center bg-slate-900/90 border border-white/15 rounded-full p-1 shadow-lg backdrop-blur-md shrink-0">
            <button
              onClick={(e) => requestExpandedMode(e.nativeEvent, 'campaign')}
              className="px-3.5 py-1 rounded-full text-amber-300 font-extrabold text-xs hover:bg-white/10 hover:text-amber-200 transition-all cursor-pointer flex items-center gap-1 select-none"
            >
              <span>Campaign</span>
            </button>
            ...
            <button
              onClick={(e) => requestExpandedMode(e.nativeEvent, 'puzzle-maker')}
              className="px-3.5 py-1 rounded-full text-purple-300 font-extrabold text-xs hover:bg-white/10 hover:text-purple-200 transition-all cursor-pointer flex items-center gap-1 select-none"
            >
            ...
            <button
              onClick={(e) => requestExpandedMode(e.nativeEvent, 'shop')}
              className="px-3.5 py-1 rounded-full text-emerald-300 font-extrabold text-xs hover:bg-white/10 hover:text-emerald-200 transition-all cursor-pointer flex items-center gap-1 select-none"
            >
              <span>Shop</span>
            </button>
          </div>
        ...
        {/* Tier 2: Unified Daily Puzzle Title & Social Proof Bar (Compact Single-Row HUD) */}
        <div className="flex items-center justify-center gap-2 sm:gap-2.5 animate-fade-in shrink-0 select-none w-full max-w-2xl px-2 py-1 whitespace-nowrap overflow-visible">
          ...
          {/* Right: Solved Status & Completion Stats */}
